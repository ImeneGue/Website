...
<div class="container text-monospace table-responsive-md">
	...
	<form  action="<?php echo DOSSIER_BASE_LIENS;?>/index.php?action=achatBillet_3" method="post"  >
		<input type='radio' id='credit' name='paiement' value='credit' required >
		<label for='male'>Carte de crédit</label>
		<input type='radio' id='compte' name='paiement' value='compte'>
		<label for='male'>Au compte</label><br>
